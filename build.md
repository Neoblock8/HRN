...
```bash
git clone https://github.com/Neoblock8/HRN.git
...
<dependency>
    ...
    <artifactId>hrnetwork-chain-w001</artifactId>
...
* Building using [IntelliJ IDEA](https://www.jetbrains.com/idea/) (community version is enough):
  ...
  **Please run ./gradlew build once to build the protocol files**
  ...
  1. Start IntelliJ. Select `File` -> `Open`, then locate to the HRN folder which you have git cloned to your local drive. Then click `Open` button on the right bottom.
