...
public class Parameter {
  ...
  public static class ChainSymbol {
    ...
    public static final byte[] HRN_SYMBOL_BYTES = "_".getBytes(); // HRN symbol
  }
  ...
  public class ChainConstant {
    ...
    public static final int BLOCK_PRODUCED_INTERVAL = 10000; //ms,produce block period, must be divisible by 60. millisecond
    ...
    public static final long HRN_PRECISION = 1000_000L;
  }
