...
public class Util {
  ...
  public static byte[] generateContractAddress(Transaction hrn, byte[] ownerAddress) {
    // get tx hash
    byte[] txRawDataHash = Sha256Hash
        .of(CommonParameter.getInstance().isECKeyCryptoEngine(), hrn.getRawData().toByteArray())
        .getBytes();
