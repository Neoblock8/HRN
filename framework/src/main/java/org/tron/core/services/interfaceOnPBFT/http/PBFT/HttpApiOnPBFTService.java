...
import org.tron.core.services.interfaceOnPBFT.http.GetBurnHrnOnPBFTServlet;
...
public class HttpApiOnPBFTService implements Service {
  ...
  @Autowired
  private GetBurnHrnOnPBFTServlet getBurnHrnOnPBFTServlet;
  @Autowired
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(getBurnHrnOnPBFTServlet),
          "/getburnhrn");
